...
/*!**************************!*\
  !*** ./actions/index.js ***!
  \**************************/
/*! exports provided: reloadHome, fetchReminders, receiveReminders, updateNewReminder, selectReminder, fetchRemindersCall, newReminderCall, deleteReminder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reloadHome", function() { return reloadHome; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateNewReminder", function() { return updateNewReminder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectReminder", function() { return selectReminder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchRemindersCall", function() { return fetchRemindersCall; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newReminderCall", function() { return newReminderCall; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deleteReminder", function() { return deleteReminder; });
...
var reloadHome = function reloadHome() {
  return {
    type: "RELOAD_HOME"
  };
};
var fetchReminders = function fetchReminders() {
  return {
...
var updateNewReminder = function updateNewReminder(newReminderValue) {
  return {
    type: "UPDATE_NEW_REMINDER",
    newReminderValue: newReminderValue
  };
};
var selectReminder = function selectReminder(selectReminderId) {
  return {
    type: "SELECT_REMINDER",
    selectReminderId: selectReminderId
  };
}; // ASYNC FUNCTIONS

function fetchRemindersCall() {
  return function (dispatch) {
    cross_fetch__WEBPACK_IMPORTED_MODULE_1___default()("http://localhost:3000/reminders", {
      cache: "no-store"
    }).then(function (res) {
      return res.json();
    }).then(function (json) {
      return dispatch(receiveReminders(json));
    }).then(function (error) {
      return console.log(error);
    });
  };
}
function newReminderCall(content) {
  return function (dispatch) {
    cross_fetch__WEBPACK_IMPORTED_MODULE_1___default()("http://localhost:3000/reminders", {
      method: 'POST',
      headers: {
    ...
    }).then(dispatch(updateNewReminder(""))).then(dispatch(fetchRemindersCall())).then(function (error) {
      return console.log(error);
    });
  };
}
function deleteReminder(id) {
  return function (dispatch) {
    cross_fetch__WEBPACK_IMPORTED_MODULE_1___default()("http://localhost:3000/reminders/" + id, {
      method: 'DELETE'
    }).then(dispatch(fetchRemindersCall())).then(function (error) {
      return console.log(error);
    });
  };
}
...
/***/ "./components/content/addReminder.js":
/*!*******************************************!*\
  !*** ./components/content/addReminder.js ***!
  \*******************************************/
...
var AddReminderInput =
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_5__["default"])(AddReminderInput, _React$Component);

  function AddReminderInput(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, AddReminderInput);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(AddReminderInput).call(this, props));
    ...
    _this.handleContainerClick = _this.handleContainerClick.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this));
    _this.inputRef = react__WEBPACK_IMPORTED_MODULE_6___default.a.createRef();
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AddReminderInput, [{
    key: "handleKeypress",
    ...
    key: "reminderBlank",
    value: function reminderBlank(s) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    updateNewReminder: function updateNewReminder(newReminderValue) {
      console.log("New reminder value from component: ");
      console.log(newReminderValue);
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_8__["updateNewReminder"])(newReminderValue));
    },
    addReminder: function addReminder(content) {
      console.log("Add new reminder to list");
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_8__["newReminderCall"])(content));
    }
  };
};
...
AddReminderInput = Object(react_redux__WEBPACK_IMPORTED_MODULE_7__["connect"])(mapStateToProps, mapDispatchToProps)(AddReminderInput);
/* harmony default export */ __webpack_exports__["default"] = (AddReminderInput);
...
/* harmony import */ var _addReminder__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./addReminder */ "./components/content/addReminder.js");
/* harmony import */ var _reminder__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./reminder */ "./components/content/reminder.js");
...
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Content, _React$Component);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Content, [{
    ...
    key: "render",
    value: function render() {
      var remindersElements = this.props.remindersList.map(function (reminder, i) {
        return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_reminder__WEBPACK_IMPORTED_MODULE_9__["default"], {
          key: reminder.id,
          reminder: reminder
        });
      });
      ...
      }, remindersElements, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_addReminder__WEBPACK_IMPORTED_MODULE_8__["default"], null)));
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    reloadHome: function reloadHome() {
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_7__["reloadHome"])());
    },
    fetchRemindersCall: function fetchRemindersCall() {
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_7__["fetchRemindersCall"])());
    }
  };
};
...
Content = Object(react_redux__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStateToProps, mapDispatchToProps)(Content);
...
/* harmony import */ var react_ionicons_lib_IosRefresh__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-ionicons/lib/IosRefresh */ "./node_modules/react-ionicons/lib/IosRefresh.js");
/* harmony import */ var react_ionicons_lib_IosRefresh__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_ionicons_lib_IosRefresh__WEBPACK_IMPORTED_MODULE_3__);
...
var Navbar = function Navbar(_ref) {
  var reloadHome = _ref.reloadHome,
      isLoading = _ref.isLoading,
      remindersCount = _ref.remindersCount;
  ...
  }, "recall5", " ", isLoading && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_ionicons_lib_IosRefresh__WEBPACK_IMPORTED_MODULE_3___default.a, {
    fontSize: "24px",
    color: "#fff",
    rotate: true
  })));
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    reloadHome: function reloadHome() {
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_2__["reloadHome"])());
    }
  };
};
...
Navbar = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(Navbar);
...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=%2Fhome%2Fricardo%2FProjects%2Frecall5%2Fpages%2Findex.js!./":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=%2Fhome%2Fricardo%2FProjects%2Frecall5%2Fpages%2Findex.js ***!
  \**********************************************************************************************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/react-ionicons/lib/IosRefresh.js":
/*!*******************************************************!*\
  !*** ./node_modules/react-ionicons/lib/IosRefresh.js ***!
  \*******************************************************/
/*! no static exports found */
...
var _jsxFileName = "/home/ricardo/Projects/recall5/pages/index.js";
...
var store = Object(redux__WEBPACK_IMPORTED_MODULE_4__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_5__["default"], Object(redux__WEBPACK_IMPORTED_MODULE_4__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_3__["default"]));
...
var App = function App() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_6__["Provider"], {
    ...
    __self: this
  }, "Recall5"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("link", {
    ...
    __self: this
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_content_content__WEBPACK_IMPORTED_MODULE_2__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19
    },
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
/* harmony import */ var _navbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./navbar */ "./reducers/navbar.js");
/* harmony import */ var _reminders__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reminders */ "./reducers/reminders.js");



var recall5RootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  navbar: _navbar__WEBPACK_IMPORTED_MODULE_1__["default"],
  reminders: _reminders__WEBPACK_IMPORTED_MODULE_2__["default"]
});
/* harmony default export */ __webpack_exports__["default"] = (recall5RootReducer);
...
var reminders = function reminders() {
  ...
  switch (action.type) {
    ...
    case "ADD_REMINDER":
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, {
        list: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(state.list), [state.addReminderValue]),
...
/***/ 0:
/*!**************************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2F&absolutePagePath=%2Fhome%2Fricardo%2FProjects%2Frecall5%2Fpages%2Findex.js ***!
  \**************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2F&absolutePagePath=%2Fhome%2Fricardo%2FProjects%2Frecall5%2Fpages%2Findex.js! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=%2Fhome%2Fricardo%2FProjects%2Frecall5%2Fpages%2Findex.js!./");
